...
class AddProductToChartUseCaseTests: XCTestCase {
    func testAddTwoProductsToChartOneByOne() throws {
        ...
        _ = useCase.execute(Product(id: UUID().uuidString, name: "Name", description: "Desc", price: 10.0))
        let chart = useCase.execute(Product(id: UUID().uuidString, name: "Name", description: "Desc", price: 10.0))
